        ...
        <div className="space-y-4">
          ...
          {event.tickets.map((ticket) => {
            ...
            return (
              <div
                key={ticket.type}
                className="p-4 border rounded-lg flex flex-col sm:flex-row justify-between items-center bg-gray-50"
              >
                {/* Ticket Details */}
                <div className="flex-grow mb-4 sm:mb-0">
                  ...
                  <p
                    className={`text-sm ${ticket.ticketsAvailable > 0 ? "text-gray-600" : "text-red-600 font-bold"}`}
                  >
                ...
                {/*  Counter and Add to Cart Button Section */}
                <div className="flex items-center space-x-3">
                  <div className="flex items-center border rounded-lg">
                    <button
                      ...
                      disabled={
                        currentQuantity <= 1 || ticket.ticketsAvailable === 0
                      }
